...
export type AppearancesJson = Node & {
  id: Scalars['ID'],
  parent?: Maybe<Node>,
  children: Array<Node>,
  internal: Internal,
...
export type AppearancesJsonDateArgs = {
...
export type AppearancesJsonConnection = {
...
export type AppearancesJsonConnectionDistinctArgs = {
  field: AppearancesJsonFieldsEnum
};


export type AppearancesJsonConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>,
  limit?: Maybe<Scalars['Int']>,
  field: AppearancesJsonFieldsEnum
};

export type AppearancesJsonEdge = {
...
export type AppearancesJsonFilterInput = {
...
export type AppearancesJsonGroupConnection = {
  totalCount: Scalars['Int'],
  edges: Array<AppearancesJsonEdge>,
  nodes: Array<AppearancesJson>,
  pageInfo: PageInfo,
...
export type AppearancesJsonSortInput = {
...
export type Query = {
  ...
  allAppearancesJson?: Maybe<AppearancesJsonConnection>,
...
export type QueryAppearancesJsonArgs = {
  id?: Maybe<StringQueryOperatorInput>,
  parent?: Maybe<NodeFilterInput>,
  children?: Maybe<NodeFilterListInput>,
  internal?: Maybe<InternalFilterInput>,
...
export type QueryAllAppearancesJsonArgs = {
...
export enum SiteFieldsEnum {
  ...
  SiteMetadataSocialUrlsMail = 'siteMetadata___socialUrls___Mail',
  SiteMetadataSocialUrlsStackOverflow = 'siteMetadata___socialUrls___StackOverflow',
  SiteMetadataSocialUrlsLinkedin = 'siteMetadata___socialUrls___Linkedin',
  SiteMetadataSocialUrlsTwitter = 'siteMetadata___socialUrls___Twitter',
  SiteMetadataSocialUrlsTelegram = 'siteMetadata___socialUrls___Telegram',
  SiteMetadataSocialUrlsGithub = 'siteMetadata___socialUrls___Github',
  SiteMetadataSocialUrlsMedium = 'siteMetadata___socialUrls___Medium',
  SiteMetadataSocialUrlsYoutube = 'siteMetadata___socialUrls___Youtube',
  SiteMetadataSocialUrlsDevTo = 'siteMetadata___socialUrls___DevTo',
  Port = 'port',
  Host = 'host',
...
export enum SitePageFieldsEnum {
  ...
  PluginCreatorPluginOptionsShowInfo = 'pluginCreator___pluginOptions___showInfo',
...
export enum SitePluginFieldsEnum {
  ...
  PluginOptionsPluginsPluginOptionsShowInfo = 'pluginOptions___plugins___pluginOptions___showInfo',
  ...
  PluginOptionsShowInfo = 'pluginOptions___showInfo',
...
export type SiteSiteMetadataSocialUrls = {
...
export type SiteSiteMetadataSocialUrlsFilterInput = {
...
export type PersonInfoQueryQuery = { avatar: Maybe<{ childImageSharp: Maybe<{ fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, site: Maybe<{ siteMetadata: Maybe<(Pick<SiteSiteMetadata, 'author'> & { socialUrls: Maybe<Pick<SiteSiteMetadataSocialUrls, 'Twitter' | 'StackOverflow' | 'Github' | 'Linkedin' | 'Medium' | 'Telegram' | 'Youtube' | 'Mail' | 'DevTo'>> })> }> };
...
export type AppearancesPageQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allAppearancesJson: Maybe<{ edges: Array<{ node: Pick<AppearancesJson, 'id' | 'url' | 'date' | 'name' | 'host' | 'location' | 'slidesUrl'> }> }> };

export type BlogPostsPageQueryQueryVariables = {};


export type BlogPostsPageQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, posts: Maybe<{ edges: Array<{ node: (Pick<MarkdownRemark, 'id' | 'excerpt'> & { fields: Maybe<(Pick<MarkdownRemarkFields, 'slug'> & { readingTime: Maybe<Pick<MarkdownRemarkFieldsReadingTime, 'text'>> })>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title'>> }) }> }> };

export type IndexPageQueryQueryVariables = {};


export type IndexPageQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, posts: Maybe<(Pick<MarkdownRemarkConnection, 'totalCount'> & { edges: Array<{ node: (Pick<MarkdownRemark, 'id' | 'excerpt'> & { fields: Maybe<(Pick<MarkdownRemarkFields, 'slug'> & { readingTime: Maybe<Pick<MarkdownRemarkFieldsReadingTime, 'text'>> })>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title'>> }) }> })> };
...
export type AboutBySlugQueryQuery = { markdownRemark: Maybe<(Pick<MarkdownRemark, 'id' | 'html' | 'excerpt'> & { fields: Maybe<(Pick<MarkdownRemarkFields, 'slug'> & { readingTime: Maybe<Pick<MarkdownRemarkFieldsReadingTime, 'text'>> })>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title'>> })> };
...
export type BlogPostBySlugQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'author'>> }>, markdownRemark: Maybe<(Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'> & { fields: Maybe<(Pick<MarkdownRemarkFields, 'slug'> & { readingTime: Maybe<Pick<MarkdownRemarkFieldsReadingTime, 'text'>> })>, frontmatter: Maybe<(Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'featuredImageAlt' | 'date'> & { rawDate: MarkdownRemarkFrontmatter['date'] } & { featuredImage: Maybe<{ internal: Pick<Internal, 'mediaType'>, childImageSharp: Maybe<{ resize: Maybe<Pick<ImageSharpResize, 'src'>> }> }> })> })> };
