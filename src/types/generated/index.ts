...
export type PersonInfoQueryQuery = { avatar: Maybe<{ childImageSharp: Maybe<{ fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, site: Maybe<{ siteMetadata: Maybe<(Pick<SiteSiteMetadata, 'author'> & { socialUrls: Maybe<Pick<SiteSiteMetadataSocialUrls, 'Twitter' | 'StackOverflow' | 'Github' | 'Linkedin' | 'Medium' | 'Telegram' | 'Youtube' | 'Mail'>> })> }> };
